...
ActiveRecord::Schema.define(version: 2021_06_20_190822) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "token"
    t.boolean "suspension_required", default: false
    t.integer "suspension_required_by_id"
  end
  ...
  create_table "products", force: :cascade do |t|
    t.string "name"
    t.decimal "price"
    t.decimal "sale_discount", default: "0.0"
    t.string "token"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "company_id"
  ...
  create_table "staffs", force: :cascade do |t|
    ...
    t.integer "company_id"
    t.string "token"
    t.boolean "staff_active", default: true
